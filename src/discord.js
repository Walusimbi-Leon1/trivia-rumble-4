/**
 * Trivia Rumble Elite — Discord SDK integration
 *
 * Proven pattern from Arrow Blast (2026-08-06), which runs smoothly in Discord:
...
// fallback for direct links (hardcoded like dice-arena/arrow-blast).
const CLIENT_ID = "1535428947624460328";
